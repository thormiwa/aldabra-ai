...
class UserRegistrationForm(UserCreationForm):
    ...
    Register a new user
    """
    first_name = forms.CharField(required=True, help_text='Enter your legal first name used in practice')
    last_name = forms.CharField(required=True, help_text='Enter your legal last name used in practice')
